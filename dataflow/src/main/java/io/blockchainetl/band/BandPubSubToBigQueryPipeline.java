package io.blockchainetl.band;

import com.google.common.collect.Lists;
import io.blockchainetl.band.domain.ChainConfig;
import io.blockchainetl.band.fns.EntityJsonToTableRow;
import io.blockchainetl.band.utils.FileUtils;
import io.blockchainetl.band.utils.JsonUtils;
...
public class BandPubSubToBigQueryPipeline {
    ...
    public static void main(String[] args) {
        ...
        List<String> entityNames = Lists.newArrayList("blocks", "transactions", "logs", "messages", "block_events", "oracle_requests");
