...
class PrivateKey:
    ...
    @classmethod
    def generate(cls, path=DEFAULT_DERIVATION_PATH):
        """
    ...
    @classmethod
    def from_mnemonic(cls, words: str, path="m/44'/494'/0'/0/0"):
        """
...
class PublicKey:
    ...
    @classmethod
    def _from_bech32(cls, bech: str, prefix: str):
